                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('company',[$listing->profile->id]) }}">
                            <img src="{{ Storage::url('$listing->profile->profile_pic') }}" alt="" width="60" class="rounded-circle">
                    ...
                    <form action="{{route('applicantion.submit',[$listing->id])}}" method="POST">@csrf
                        <button  class="btn btn-dark btn-lg mt-3">Apply Now</button>
                    </form>
                    @else
        ...
        pond.setOptions({
            server: {
                ...
                process: {
                    ...
                    onerror: (response) => {
                        console.log('error while loading resume',response)
                    }
                },
            },
        });
