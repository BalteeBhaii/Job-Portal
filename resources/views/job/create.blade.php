        ...
        <div class="col-md-8 mt-5">
            ...
            <form action="{{ route('job.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="roles" id="summernote1" class="form-control"></textarea>
                    @if($errors->has('roles'))
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" value="FullTime" id="Fulltime">
                        <label for="fulltime" class="form-check-label">FullTime</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" value="PartTime" id="PartTime">
                        <label for="partTime" class="form-check-label">PartTime</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" value="Cascual" id="cascual">
                        <label for="cascual" class="form-check-label">Cascual</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="job_type" value="Contract" id="contract">
