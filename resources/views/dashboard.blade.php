        ...
        <ol class="breadcrumb mb-4">
            ...
            @if (!auth()->user()->billing_ends)
                @if (Auth::check() && auth()->user()->user_type == 'employer')
                    <p>Your trial {{ now()->format('Y-m-d') > auth()->user()->user_trial ? 'was expired' : 'will expired' }}
                        on
            ...
            @if (auth()->user()->billing_ends)
                @if (Auth::check(0 && auth()->user()->user_type == 'employer'))
                    <p>Your trial
                        {{ now()->format('Y-m-d') > auth()->user()->billing_ends ? 'was expired' : 'will expired' }} on
