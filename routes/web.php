...
// we use verifed middleware when user verify your email then it should access the dashboard otherwise not
...
// get all jobs who applied for particular user
Route::get('user/job/applied' , [UserController::class, 'jobApplied'])->name('job.applied')->middleware('auth');
...
Route::get('/resend/verfication/email',[DashboardController::class, 'resend'])->name('resend.email');
